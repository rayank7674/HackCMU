...
3. Plan at `/plan` — saved location, official alert card, compact conditions, and 3–5 actions when those APIs exist. **Sign in to save** is a calm CTA until Auth0 is wired.
