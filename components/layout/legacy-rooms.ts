/**
 * Isolated leftover from the HackCMU rooms/sessions skeleton.
 * Not part of the StormReady domain contract — do not extend this model.
 * New work should import from `@/lib/stormready` (or `@/types`).
 */
